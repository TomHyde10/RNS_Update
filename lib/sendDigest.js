...
async function sendDigestForSubscription(subscription) {
  ...
  if (reports.length === 0 && isEmptyDigestThrottled(subscription.lastSentAt, now)) {
...
module.exports = { digestSendAllowed, sendDigestForSubscription, sendTestDigest, collectDigestReports, filterDigestReports, digestWindowStart, isEmptyDigestThrottled, buildDigestHtml };
