...
// `ant auth login` profile. Model defaults to Haiku 4.5 (requested
// explicitly - a short bullet-point summary doesn't need Opus-tier
// reasoning); override with ANTHROPIC_MODEL for a different one.
