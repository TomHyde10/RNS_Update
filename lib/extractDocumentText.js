...
// extracts plain text from it, for lib/summarise.js to hand to Claude.
...
// Keeps the prompt sent to Claude reasonably sized - a full filing can run
// to tens of thousands of words, most of which a short summary doesn't
// need. Configurable mainly for cost/latency tuning on very long filings.
const MAX_INPUT_CHARS = parseInt(process.env.SUMMARISE_MAX_INPUT_CHARS, 10) || 8000;
