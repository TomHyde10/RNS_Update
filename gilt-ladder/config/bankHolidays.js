...
//
// Generated by scripts/build-holidays.js from https://www.gov.uk/bank-holidays.json -
// do not hand-edit. gov.uk only publishes a rolling window, so this covers
// 2019-2028; lib/calendar.js computes the rule-based calendar for years
// outside it (see `ruleBasedHolidays`). The generated table is preferred where
// it reaches, because it is the only source for one-off holidays - state
// funerals, jubilees, coronations - which no rule can predict.
//
// Regenerate when the covered range starts running out: currently to 2028.
module.exports = {
  coveredFrom: 2019,
  coveredTo: 2028,
  dates: new Set([
